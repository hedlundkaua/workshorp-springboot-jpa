...
import com.hedlundkaua.course.services.CategoryService;
...
@RequestMapping(value = "/categories")// usamos para dar um nome para esse recurso, no caso o caminho.
public class CategoryResource {
	...
	public ResponseEntity<List<Category>> findAll(){ //a resposta agora vai ser do tipo List User
	...
	public ResponseEntity<Category> findById(@PathVariable Long id){ //para o spring aceitar o id que vem da URL
